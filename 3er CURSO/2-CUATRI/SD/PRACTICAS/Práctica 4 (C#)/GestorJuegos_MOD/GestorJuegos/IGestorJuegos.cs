...
namespace GestorJuegos
{
    ...
    public interface IGestorJuegos
    {
        ...
        //Clonar el sudoku cuyo código es pasado. Los atributos del nuevo sudoku deberán tener
        //los mismos valores que el sudoku original salvo, como es obvio, el código que lo identifica unívocamente
        //del resto de juegos.
        int ClonarJuego(int Codigo);
    }
}
