...
namespace Cliente_SW_Sudoku
{
    class Cliente_SW
    {
        ...
        public static int ListarJuegos(bool Borrar)
        {
            int valor;
        ...
        {
            int opcPrin = -1, opcDif = -1, opcGest = -1, opcJug = -1, codActual = 0, seleccion, puerto, posSudoAct = -1;
            int fil = -1, col = -1, valor = -1;
            char OKborrar;
            TipoDificultad Dificultad = TipoDificultad.VACIO;

            //### Conexión con el servidor ###
            GestorJuegos_Web.ServicioJuegosClient gestor = new GestorJuegos_Web.ServicioJuegosClient();
