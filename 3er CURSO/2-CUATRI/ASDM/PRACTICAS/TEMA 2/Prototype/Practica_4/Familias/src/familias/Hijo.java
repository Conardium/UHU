 ...
 */
public class Hijo implements Familia_Prototype{
    ...
    public Hijo(String nom, String ap, String tlf, String dir, String cp, String email, String est) {
        nombre = nom;
        apellido = ap;
        telefono = tlf;
        direccion = dir;
