 ...
 */
public class Padre implements Familia_Prototype{
    ...
    public Padre(String nom, String ap, String tlf, String dir, String cp, String email, String est) {
        nombre = nom;
        apellido = ap;
        telefono = tlf;
        direccion = dir;
