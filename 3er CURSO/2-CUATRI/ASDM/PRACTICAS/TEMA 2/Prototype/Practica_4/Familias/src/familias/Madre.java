 ...
 */
public class Madre implements Familia_Prototype{
    ...
    public Madre(String nom, String ap, String tlf, String dir, String cp, String email, String est) {
        nombre = nom;
        apellido = ap;
        telefono = tlf;
        direccion = dir;
