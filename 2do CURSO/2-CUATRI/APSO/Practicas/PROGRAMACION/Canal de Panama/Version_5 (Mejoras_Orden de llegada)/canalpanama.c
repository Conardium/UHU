...
int main()
{
  ...
  //-------- NUEVO -----------//
  int pidgesclusae, pidgesclusao, pidglago;  
  ...
  //--------- NUEVO -------- // ---------> a diferencia de las otras FIFOS, estas no se van a abrir
  ...
  //Vemos si llega10 es 1 o 0, si es 0(no ha llegado la señal) asi que hace el pause().
  if(!llega10) pause();

  
  //------------------ NUEVO ------------------ //
  //Creamos los nuevos 3 procesos               
